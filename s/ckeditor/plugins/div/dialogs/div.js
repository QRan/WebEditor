(function() {
    ...
    function q(a, m) {
        function r() {
            this.foreach(function(a) { / ^( ? !vbox | hbox) / .test(a.type) && (a.setup || (a.setup = function(c) {
        ...
        return {
            ...
            onLoad: function() {
                ...
                a.getStylesSet(function(g) {
                    var b, k;
                    if (g) for (var e = 0; e < g.length; e++) k = g[e],
                    k.element && "div" == k.element && (b = k.name, n[b] = k = new CKEDITOR.style(k), a.filter.check(k) && (c.items.push([b, b]), c.add(b, b)));
            ...
            onOk: function() {
                if ("editdiv" == m) p = [this._element];
                    ...
                    for (h = 0; h < e.length; h++) if (e[h].length) {
                        d = e[h][0];
                        g = d.getParent();
                        ...
                        for (b = 0; b < e[h].length; b++) d = e[h][b],
                        d.getCustomData && d.getCustomData("block_processed") || (d.is && CKEDITOR.dom.element.setMarker(c, d, "block_processed", !0), b || l.insertBefore(d), l.append(d));
                        CKEDITOR.dom.element.clearAllMarkers(c);
                        f.push(l)
                    }
                    k.selectBookmarks(n);
                ...
                f = p.length;
                for (c = 0; c < f; c++) this.commitContent(p[c]),
